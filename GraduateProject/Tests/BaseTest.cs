...
namespace GraduationProject.Tests
{
    class BaseTest
    {
        ...
        protected static string helmetsUrlPath = "/casti";
        protected static string accesoriesUrlPath = "/accesorii";
        protected static string bikesUrlPath = "/produse-1";
        protected static string helmetsAdultsUrlPath = "/casti-adulti";
        protected static string helmetsKidsUrlPath = "/casti-copii";
        protected static string giftsUrlPath = "/christmas-time-9";
        protected static string contactPath = "/contact";
